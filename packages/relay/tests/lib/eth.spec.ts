...
describe('Eth calls using MirrorNode', async function () {
  ...
  it('eth_getBlockByNumber with match', async function () {
    ...
    mock.onGet(`contracts/results?timestamp=gte:${defaultBlock.timestamp.from}&timestamp=lte:${defaultBlock.timestamp.to}&limit=100&order=desc`).reply(200, defaultContractResults);
  ...
  it('eth_getBlockByNumber with zero transactions', async function () {
    ...
    mock.onGet(`contracts/results?timestamp=gte:${defaultBlock.timestamp.from}&timestamp=lte:${defaultBlock.timestamp.to}&limit=100&order=desc`).reply(200, { 'results': [] });
    mock.onGet('network/fees').reply(200, defaultNetworkFees);
    const result = await ethImpl.getBlockByNumber(EthImpl.numberTo0x(blockNumber), false);
    expect(result).to.exist;
    if (result == null) return;
  ...
  it('eth_getBlockByNumber with block match and contract revert', async function () {
    ...
    mock.onGet(`contracts/results?timestamp=gte:${defaultBlock.timestamp.from}&timestamp=lte:${defaultBlock.timestamp.to}&limit=100&order=desc`).reply(200, defaultContractResultsRevert);
    mock.onGet('network/fees').reply(200, defaultNetworkFees);
  ...
  it('eth_getTransactionByBlockNumberAndIndex with match', async function () {
    // mirror node request mocks
    mock.onGet(`contracts/results?block.number=${defaultBlock.number}&transaction.index=${defaultBlock.count}&limit=100&order=desc`).reply(200, defaultContractResults);
    mock.onGet(`contracts/${contractAddress1}/results/${contractTimestamp1}`).reply(200, defaultDetailedContractResults);
  ...
  it('eth_getTransactionByBlockNumberAndIndex with no contract result match', async function () {
    mock.onGet(`contracts/results?block.number=${defaultBlock.number}&transaction.index=${defaultBlock.count}&limit=100&order=desc`).reply(400, {
      '_status': {
        'messages': [
          {
  ...
  it('eth_getTransactionByBlockNumberAndIndex with no contract results', async function () {
    mock.onGet(`contracts/results?block.number=${defaultBlock.number}&transaction.index=${defaultBlock.count}&limit=100&order=desc`).reply(200, {
      'results': []
    });
  ...
  it('eth_getTransactionByBlockNumberAndIndex with earliest tag', async function () {
    // mirror node request mocks
    mock.onGet(`contracts/results?block.number=0&transaction.index=${defaultBlock.count}&limit=100&order=desc`).reply(200, defaultContractResults);
    mock.onGet(`contracts/${contractAddress1}/results/${contractTimestamp1}`).reply(200, defaultDetailedContractResults);
  ...
  it('eth_getTransactionByBlockNumberAndIndex with hex number', async function () {
    // mirror node request mocks
    mock.onGet(`contracts/results?block.number=3735929054&transaction.index=${defaultBlock.count}&limit=100&order=desc`).reply(200, defaultContractResults);
    mock.onGet(`contracts/${contractAddress1}/results/${contractTimestamp1}`).reply(200, defaultDetailedContractResults);
  ...
  it('eth_getTransactionByBlockHashAndIndex with match', async function () {
    // mirror node request mocks
    mock.onGet(`contracts/results?block.hash=${defaultBlock.hash}&transaction.index=${defaultBlock.count}&limit=100&order=desc`).reply(200, defaultContractResults);
    mock.onGet(`contracts/${contractAddress1}/results/${contractTimestamp1}`).reply(200, defaultDetailedContractResults);
  ...
  it('eth_getTransactionByBlockHashAndIndex with no contract result match', async function () {
    // mirror node request mocks
    mock.onGet(`contracts/results?block.hash=${defaultBlock.hash}&transaction.index=${defaultBlock.count}&limit=100&order=desc`).reply(404, {
      "_status": {
        "messages": [
          {
            "message": "Not found"
  ...
  it('eth_getTransactionByBlockHashAndIndex with no contract results', async function () {
    mock.onGet(`contracts/results?block.hash=${defaultBlock.hash}&transaction.index=${defaultBlock.count}&limit=100&order=desc`).reply(200, {
      'results': []
    });
  ...
  describe('eth_getLogs', async function () {
    ...
    it('blockHash filter timeouts and throws the expected error', async function () {
      ...
      mock.onGet(`contracts/results/logs?timestamp=gte:${defaultBlock.timestamp.from}&timestamp=lte:${defaultBlock.timestamp.to}&limit=100&order=desc`).reply(200, filteredLogs);
    ...
    it('address filter timeouts and throws the expected error', async function () {
      mock.onGet("blocks?limit=1&order=desc").reply(200, { blocks: [defaultBlock] });
      mock.onGet(`contracts/${contractAddress1}/results/logs?timestamp=gte:${defaultBlock.timestamp.from}&timestamp=lte:${defaultBlock.timestamp.to}&limit=100&order=desc`).timeout();
    ...
    it('error when retrieving logs', async function () {
      mock.onGet("blocks?limit=1&order=desc").reply(200, { blocks: [defaultBlock] });
      mock.onGet(`contracts/results/logs?timestamp=gte:${defaultBlock.timestamp.from}&timestamp=lte:${defaultBlock.timestamp.to}&limit=100&order=desc`).reply(400, { "_status": { "messages": [{ "message": "Mocked error" }] } });
    ...
    it('should be able to return more than two logs with limit of two per request', async function () {
      const filteredLogs = {
        ...
        links: {next: '/api/v1/contracts/results/logs?limit=5&order=desc&timestamp=lte:1668432962.375200975&index=lt:0'}
      };
      ...
      mock.onGet(`contracts/results/logs?timestamp=gte:${defaultBlock.timestamp.from}&timestamp=lte:${defaultBlock.timestamp.to}&limit=2&order=desc`).reply(200, filteredLogs);
      filteredLogs.logs.forEach((log, index) => {
        mock.onGet(`contracts/${log.address}`).reply(200, {...defaultContract, contract_id: `0.0.105${index}`});
      });
    ...
    it('Should cache contracts/contractIdOrAddress request', async function () {
      mock.onGet("blocks?limit=1&order=desc").reply(200, { blocks: [defaultBlock] });
      mock.onGet(`contracts/results/logs?timestamp=gte:${defaultBlock.timestamp.from}&timestamp=lte:${defaultBlock.timestamp.to}&limit=100&order=desc`).reply(200, defaultLogs);
    ...
    it('address filter', async function () {
      ...
      mock.onGet("blocks?limit=1&order=desc").reply(200, { blocks: [defaultBlock] });
      mock.onGet(`contracts/${contractAddress1}/results/logs?timestamp=gte:${defaultBlock.timestamp.from}&timestamp=lte:${defaultBlock.timestamp.to}&limit=100&order=desc`).reply(200, filteredLogs);
    ...
    it('with valid fromBlock && toBlock filter', async function () {
      ...
      mock.onGet(`contracts/results/logs?timestamp=gte:${defaultBlock.timestamp.from}&timestamp=lte:${toBlock.timestamp.to}&limit=100&order=desc`).reply(200, filteredLogs);
      for (const log of filteredLogs.logs) {
        mock.onGet(`contracts/${log.address}`).reply(200, defaultContract);
      }
    ...
    it('with non-existing toBlock filter', async function () {
      ...
      mock.onGet('blocks/5').reply(200, defaultBlock);
      mock.onGet('blocks/16').reply(404, {"_status": { "messages": [{"message": "Not found"}]}});
      mock.onGet(`contracts/results/logs?timestamp=gte:${defaultBlock.timestamp.from}&limit=100&order=desc`).reply(200, filteredLogs);
    ...
    it('with topics filter', async function () {
      ...
      mock.onGet(
        ...
        `&topic2=${defaultLogTopics[2]}&topic3=${defaultLogTopics[3]}&limit=100&order=desc`
